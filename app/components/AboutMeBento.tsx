    ...
    <BentoCard height="h-[275px] md:h-[304px] lg:h-[220px]" linkTo={linkTo}>
      <div className="group flex h-full">
        <div className="text-balance">
          <h2 className="mb-4 text-base font-medium">See my projects!</h2>
          <p className="mb-2 text-balance pr-1 text-text-secondary md:pr-4">
            View my demo videos, Hackathon wins and code for projects in fintech, edtech, deep tech and more.
          </p>
        </div>
