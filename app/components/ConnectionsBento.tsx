      ...
      >
        ...
        <div>
          ...
          <span className="absolute left-1/2 top-2.5 -translate-x-1/2">
            <div className="relative mt-9">
              ...
              <img
                className="absolute left-1/2 top-1/2 h-[120px] w-[90px] -translate-x-1/2 -translate-y-1/2 transform rounded-full"
                src="/profile.png"
                alt=""
              />
            </div>
        ...
        <div className="z-20 mt-auto w-full text-balance text-center">
          ...
          <p className="mt-1 text-text-secondary">
            An evolving list of experience I&apos;ve had and hope to grow!
          </p>
        </div>
      </div>
    </BentoCard>
