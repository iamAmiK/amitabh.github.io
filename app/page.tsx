            ...
            <div className="relative h-fit w-full overflow-hidden">
              ...
              <div className="grid grid-cols-1 gap-8 py-0 lg:grid-cols-2 lg:items-center lg:justify-between lg:pl-12">
                <div className="flex flex-col items-center text-left lg:items-start">
                  ...
                  <br />
                  <br />
                  At <WavyHighlight delay={400}>UNSW as a Software Engineering (Honours) student</WavyHighlight>, I’ve been fortunate to <WavyHighlight delay={600}>achieve strong results</WavyHighlight>, including <WavyHighlight delay={400}>scoring in the top 1% of my cohort in Software Engineering Fundamentals and Requirements and Design</WavyHighlight> and <WavyHighlight delay={800}>receiving a Letter of Recommendation from the Director of Software Engineering at UNSW, Prof. Fethi Rabhi.</WavyHighlight> These experiences confirmed that my place lies at the intersection of technology, product and innovation.
                  </p>
                </div>
